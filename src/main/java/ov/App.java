...
/**
 * Create by Peerachart Piriyarattanachai
 *
 */
public class App 
{
    ...
    public static void main( String[] args ) throws IOException {
        ...
        String labeledPath = System.getProperty("user.home")+"/Desktop/ov_250";
        ...
        // Canova to DL4J
        DataSetIterator ov = new RecordReaderDataSetIterator(recordReader,batchSize,numRows*numColumns, labels.size());
